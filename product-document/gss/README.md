...
영국에 본사를 두고 있는 Gas Sensing Solution은 Solid-State NDIR(비분산 적외선) LED 기반 가스 센서의 글로벌 리더입니다. LED와 함께 사용되는 광검출기는 MBE(분자선 결정 성장 시스템) 기계를 통해 직접 제조 되며, 특허를 받은 모든 NDIR 확산 CO₂ 센서에 사용이 됩니다.
...
| -- | -- | -- |
|<img src="/.gitbook/assets/CozIRex.jpg" width="150px" height="150px"></img>|![](../../.gitbook/assets/ExplorIRex.jpg)|![](../../.gitbook/assets/SprintIRex.jpg)|
