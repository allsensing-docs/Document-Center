...
![2)CozIR CO2 Sensor+PCB](../../.gitbook/assets/cozir\_option.jpg)



1. 위 1)그림과 같이 Arduino Due와 PCB 연결(1번:Vcc 2번:GND 24번:Rx 25번:Tx) \*Allsensing 자체 제작 PCB에서는 Rx, Tx를 서로 교차해서 연결하면 됩니다.
