...
|          |                                                                                                                                                                                                                                                                                                         |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **하드웨어** | <p><em>CozIR-LP2 CO₂ 센서</em><br><a href="https://www.allsensing.com/product/detail.html?product_no=1171&#x26;cate_no=65&#x26;display_group=1">CozIR용 PCB</a>(Connector 포함 / Allsensing </p><p>자체 제작) -> Soldering보다는 PCB 사용 권장<br>*Arduino Due(3.3V)(Arduino Uno Rev3(5V)가능) -> Arduino Due 3.3V 권장</p> |
